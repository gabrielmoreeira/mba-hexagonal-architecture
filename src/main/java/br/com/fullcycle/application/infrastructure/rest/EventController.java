...
import br.com.fullcycle.application.infrastructure.dtos.NewEventDTO;
import br.com.fullcycle.application.infrastructure.dtos.SubscribeDTO;
...
public class EventController {
    ...
    public ResponseEntity<?> create(@RequestBody NewEventDTO dto) {
        try {
            final var output =
                    createEventUseCase.execute(new CreateEventUseCase.Input(dto.date(),
                            dto.name(),
                            dto.partnerId(),
                            dto.totalSpots()));
