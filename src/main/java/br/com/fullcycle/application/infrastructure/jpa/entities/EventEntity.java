package br.com.fullcycle.application.infrastructure.jpa.entities;
...
public class EventEntity {
    ...
    public Event toEvent() {
        // Se getTickets() for null, usa um Set vazio
        var ticketsList = this.getTickets() == null
                ? Collections.<EventTicketEntity>emptySet()
                : this.getTickets();
